...
<body>
	...
	<div id="global">
		<form:form modelAttribute="employee" action="employee_save" method="post" enctype="multipart/form-data" acceptCharset="UTF-8">
			<fieldset>
				<legend>Add an employee</legend>
				<p>
					<label for="employeeImage">
						<spring:message code="addEmployee.form.employeeImage.label" />
					</label>
					<form:input path="employeeImage" id="employeeImage" type="file" class="form:input-large" />
				</p>
				<p>
